            ...
            <main class="flex-1 container mx-auto px-6 mt-6">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <img src="images/img2.jpg" alt="Membership" class="w-[400px] h-[200px] object-cover rounded mb-4">
                        ...
                        <a href="{{ route('membership.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition">Join Now</a>
                    </div>
                    ...
                    <img src="images/img3.jpg" alt="Membership" class="w-[400px] h-[200px] object-cover rounded mb-4">
                        ...
                        <a href="{{ route('class-schedule.index') }}" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 transition">View Schedule</a>
                    </div>
